...
from mq_hb.surrogate.weighted_rf_ensemble import WeightedRandomForestCluster
            ...
            if self.weight_method in ['rank_loss_softmax', 'rank_loss_single', 'rank_loss_p_norm']:
                ...
                for i, r in enumerate(r_list):
                    ...
                    if i != K - 1:
                        ...
                        preorder_num, pair_num = mqMFES.calculate_preserving_order_num(tmp_y, test_y)
                        ...
                        if len(test_y) < 2 * fold_num:
                            ...
                            preorder_num, pair_num = mqMFES.calculate_preserving_order_num(cv_pred, test_y)
                            preserving_order_p.append(preorder_num / pair_num)
                            preserving_order_nums.append(preorder_num)
                ...
                for _ in range(sample_num):
                    ...
                    for idx in range(K - 1):
                        ...
                        _num, _ = mqMFES.calculate_preserving_order_num(sampled_y, test_y)
                    ...
                    if len(test_y) < 2 * fold_num:
                        ...
                        _num, _ = mqMFES.calculate_preserving_order_num(cv_pred, test_y)
                        order_preseving_nums.append(_num)
