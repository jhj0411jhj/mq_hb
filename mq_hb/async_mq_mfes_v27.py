...
class async_mqMFES_v27(async_mqHyperband):
    """
    ...
    === from v13
    v26: choose n_iteration of new config by weight (random choice from top 2 power 3)
         RandomSampling
         weight_method='rank_loss_prob'
         non_decreasing_weight=False, increasing_weight=True
    v27: test bohb using weight choosing
    """
    ...
    def update_weight(self):
        ...
        # for i, r in enumerate(r_list):
        #     self.surrogate.surrogate_weight[r] = new_weights[i]   # test bohb
