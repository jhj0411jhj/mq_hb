...
class async_mqMFES_v24(async_mqHyperband):
    """
    The implementation of Asynchronous MFES (combine ASHA and MFES)
    v24:
    set_promotion_threshold=False,
    use 3 promote 1 asha after 3 hyperband loop (test_original_asha=True init)
    """
