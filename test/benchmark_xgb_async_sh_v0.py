...
python test/benchmark_xgb_async_sh_v0.py --datasets spambase --R 27 --n_jobs 4 --n_workers 1 --runtime_limit 60 \
--rep 1 --start_id 0
...
if R == 27:
    ...
    algo_name = 'asha%d_v0' % R
algo_class = async_mqSuccessiveHalving_v0
