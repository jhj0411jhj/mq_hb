...
python test/benchmark_xgb_async_mfes_old.py --datasets spambase --R 27 --n_jobs 4 --n_workers 1 --rand_prob 0.3 \
...
from mq_hb.async_mq_mfes_old import async_mqMFES_old
