...
class async_mqMFES_v2(async_mqHyperband):
    """
    The implementation of Asynchronous MFES (combine ASHA and MFES)
    before fix. update weight when changing bracket
    use bo surrogate when full observation >= 3
    with median
    """
    ...
    def choose_next(self):
        ...
        if len(self.target_y[self.iterate_r[-1]]) < 3:      # todo
