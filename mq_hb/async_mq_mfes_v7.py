...
class async_mqMFES_v7(async_mqHyperband):
    """
    ...
    v7: non_decreasing_weight start threshold
    """
    ...
    def __init__(self, objective_func,
        ...
        self.non_decreasing_weight_start = 7
    ...
    def update_weight(self):
        ...
        if self.non_decreasing_weight and len(incumbent_configs) > self.non_decreasing_weight_start:    # v7
