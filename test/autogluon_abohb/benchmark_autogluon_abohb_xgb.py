...
python test/autogluon_abohb/benchmark_autogluon_abohb_xgb.py --R 27 --reduction_factor 3 --brackets 4 --num_cpus 15 --n_workers 8 --n_jobs 15 --timeout 600 --dataset covtype --rep 1 --start_id 0
