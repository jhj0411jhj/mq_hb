...
class mqMFES_v8(mqBaseFacade):
    ...
    def __init__(self, objective_func,
                 ...
                 weight_method='rank_loss_prob', fusion_method='idp',
                 power_num=3,
    ...
    def get_bo_candidates(self, num_configs):
        ...
        self.acquisition_function.update(model=self.weighted_surrogate, eta=std_incumbent_value,
                                         num_data=len(self.history_container.data))
        candidates = self.acq_optimizer.maximize(best_config=best_config, batch_size=max(5000, num_configs))
        return candidates[:num_configs]  # todo
