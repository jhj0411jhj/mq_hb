...
python test/benchmark_xgb_bohb.py --datasets spambase --R 27 --n_jobs 4 --n_workers 1 --rand_prob 0.3 --init_num 3 \
...
parser.add_argument('--init_num', type=int, default=3)
