...
python test/benchmark_xgb_mfes_v2.py --datasets spambase --R 27 --n_jobs 4 --n_workers 1 --rand_prob 0.3 \
...
from mq_hb.mq_mfes_v2 import mqMFES_v2
...
def evaluate_parallel(method_id, n_workers, dataset, seed, ip, port):
    ...
    def master_run(return_list):
        algo = mqMFES_v2(None, cs, R, eta=eta,
                         rand_prob=rand_prob,
...
for dataset in test_datasets:
    ...
    for i in range(start_id, start_id + rep):
        ...
        method_str = 'mfesv2-n%d' % (n_workers,)
